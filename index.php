            ...
            <div>
                <div class="col-12" style="background-color: white;">
                    <nav class="main-nav" style="font-size: 0.5em">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a style="font-size: 1.5em;font-weight: bold;" href="#"
...
<div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="slide-show-text">
                ...
                <div class="slideshow-container">
                    <div class="slideshow-inner">
                        <div class="mySlides">
                            <p class="font-1em">Your reliable and trusted service provider</p>
                        </div>

                        <div class="mySlides">
                            <p class="font-1em"> for all your Aviation,</p>
                        </div>

                        <div class="mySlides">
                            <p class="font-1em">Aircraft Maintenance and Marine needs.</p>
                        </div>
                    </div>
            ...
            <div class="logo-bar">
                <h2 style="padding: 20px; font-size: 2em; color: #044fad;">Supporting Aircraft and Helicopters</h2>
                <div class="row">
                    <div class="col-xl-3 col-md-3 col-sm-6 col-6">
                        <a target="_blank"><img class="logo-img"
                                src="assets/images/logos/logo1.png"></a>
                    </div>
                    <div class="col-xl-3 col-md-3 col-sm-6 col-6">
                        <a target="_blank"><img class="logo-img-special"
                                src="assets/images/logos/logo2.jpg"></a>
                    </div>
                    <div class="col-xl-3 col-md-3 col-sm-6 col-6">
                        <a target="_blank"><img class="logo-img-special"
                                src="assets/images/logos/logo3.jpg"></a>
                    </div>
                    <div class="col-xl-3 col-md-3 col-sm-6 col-6">
                        <a target="_blank"><img class="logo-img"
                                src="assets/images/logos/logo5.png"></a>
                    </div>
                    <div class="col-xl-3 col-md-3 col-sm-6 col-6">
                    <a target="_blank"><img class="logo-img"
                                src="assets/images/logos/logo6.jpg"></a>
                    </div>
                    <div class="col-xl-3 col-md-3 col-sm-6 col-6">
                        <a target="_blank"><img
                                class="logo-img-special" src="assets/images/logos/logo7.png"></a>
                    </div>
                    <div class="col-xl-3 col-md-3 col-sm-6 col-6">
                        <a target="_blank"><img class="logo-img-special"
                                src="assets/images/logos/logo8.jpg"></a>
                    </div>
                    <div class="col-xl-3 col-md-3 col-sm-6 col-6">
                        <a target="_blank"><img class="logo-img-special"
                                src="assets/images/logos/logo9.png"></a>
                    </div>
                    <div class="col-xl-3 col-md-3 col-sm-6 col-6">
                    <a target="_blank"><img style="width: 70%"
                                src="assets/images/logos/logo4.png"></a>
                    </div>
                    <div class="col-xl-3 col-md-3 col-sm-6 col-6">
                        <a target="_blank"><img
                                class="logo-img" src="assets/images/logos/logo10.png"></a>
                    </div>
                </div>
            </div>
        </div>
